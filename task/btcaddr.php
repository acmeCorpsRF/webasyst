<?php
/**
 * Приложение к тестовому заданию для вакансии Frontend-разработчик
 * в компании Webasyst (октябрь 2019).
 * https://hh.ru/vacancy/34143987
 *
...
function apiRun() {
    ...
    // Comment the following line to remove delay, or edit to increase wait time.
    sleep(mt_rand(1, 3));
